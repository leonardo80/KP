...
namespace KP {
    ...
    public class LaporanPiutang : ReportClass {
    ...
    public class CachedLaporanPiutang : Component, ICachedReport {
        
        public CachedLaporanPiutang() {
        }
